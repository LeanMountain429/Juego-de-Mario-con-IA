...
function game(){
  ...
  if(gameConfig.status==='gameover'){
    ...
    textSize(15);
    text("Presiona el boton para iniciar", gameConfig.screenX/2, gameConfig.screenY/2+135);
    textSize(40);
...
// Cambiar el estado del juego si se presiona cualquier tecla agregar noseX 
...
// El personaje obtiene monedas agregar mario_coin.play();
...
/* Control manual del personaje agregar if */
...
/* Movimientos del personaje agregar mario_jump.play(); */
...
// Hacer que el personaje muera si es tocado por el enemigo agregar mario_die.play();
...
// Comprobar el estado del personaje y la respuesta al sprite y al estado del juego agregar mario_gameover.play();
